...
from app.lightrag.api.utils_api import display_splash_screen, check_env_file
from app.lightrag.api.config import global_args
...
def main():
    ...
    from app.lightrag.api.config import initialize_config
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from app.lightrag.api import gunicorn_config
        ...
        def load(self):
            ...
            from app.lightrag.api.lightrag_server import get_application
