...
from app.lightrag.api.utils_api import (
...
from app.lightrag.utils import get_env_value
from lightrag import LightRAG, __version__ as core_version
from app.lightrag.api import __api_version__
from app.lightrag.types import GPTKeywordExtractionFormat
from app.lightrag.utils import EmbeddingFunc
from app.lightrag.constants import (
...
from app.lightrag.api.routers.document_routes import (
    DocumentManager,
    create_document_routes,
)
from app.lightrag.api.routers.query_routes import create_query_routes
from app.lightrag.api.routers.graph_routes import create_graph_routes
from app.lightrag.api.routers.ollama_api import OllamaAPI

from app.lightrag.utils import logger, set_verbose_debug
from app.lightrag.kg.shared_storage import (
    get_namespace_data,
...
from app.lightrag.api.auth import auth_handler
...
class LLMConfigCache:
    ...
    def __init__(self, args):
        ...
        if args.llm_binding in ["openai", "azure_openai"]:
            from app.lightrag.llm.binding_options import OpenAILLMOptions
        ...
        if args.llm_binding == "gemini":
            from app.lightrag.llm.binding_options import GeminiLLMOptions
        ...
        if args.llm_binding == "ollama":
            try:
                from app.lightrag.llm.binding_options import OllamaLLMOptions
        ...
        if args.embedding_binding == "ollama":
            try:
                from app.lightrag.llm.binding_options import OllamaEmbeddingOptions
        ...
        if args.embedding_binding == "gemini":
            try:
                from app.lightrag.llm.binding_options import GeminiEmbeddingOptions
...
def create_app(args):
    ...
    def create_optimized_openai_llm_func(
        ...
        async def optimized_openai_alike_model_complete(
            ...
            **kwargs,
            ...
            from app.lightrag.llm.openai import openai_complete_if_cache
    ...
    def create_optimized_azure_openai_llm_func(
        ...
        async def optimized_azure_openai_model_complete(
            ...
            **kwargs,
            ...
            from app.lightrag.llm.azure_openai import azure_openai_complete_if_cache
    ...
    def create_optimized_gemini_llm_func(
        ...
        async def optimized_gemini_model_complete(
            ...
            **kwargs,
            ...
            from app.lightrag.llm.gemini import gemini_complete_if_cache
    ...
    def create_llm_model_func(binding: str):
        ...
        try:
            if binding == "lollms":
                from app.lightrag.llm.lollms import lollms_model_complete

                return lollms_model_complete
            elif binding == "ollama":
                from app.lightrag.llm.ollama import ollama_model_complete
    ...
    def create_optimized_embedding_function(
        ...
        try:
            if binding == "openai":
                from app.lightrag.llm.openai import openai_embed

                provider_func = openai_embed
            elif binding == "ollama":
                from app.lightrag.llm.ollama import ollama_embed

                provider_func = ollama_embed
            elif binding == "gemini":
                from app.lightrag.llm.gemini import gemini_embed

                provider_func = gemini_embed
            elif binding == "jina":
                from app.lightrag.llm.jina import jina_embed

                provider_func = jina_embed
            elif binding == "azure_openai":
                from app.lightrag.llm.azure_openai import azure_openai_embed

                provider_func = azure_openai_embed
            elif binding == "aws_bedrock":
                from app.lightrag.llm.bedrock import bedrock_embed

                provider_func = bedrock_embed
            elif binding == "lollms":
                from app.lightrag.llm.lollms import lollms_embed
    ...
    async def bedrock_model_complete(
        ...
        **kwargs,
        ...
        # Lazy import
        from app.lightrag.llm.bedrock import bedrock_complete_if_cache
    ...
    if args.rerank_binding != "null":
        from app.lightrag.rerank import cohere_rerank, jina_rerank, ali_rerank
    ...
    from app.lightrag.api.config import OllamaServerInfos
